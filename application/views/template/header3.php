...
<body>
    <header style="background-image: url('<?=base_url()?>assets/img/souvenir.jpg');s">
    ...
    <ul>
        ...
        <li style="float:right"><a href="<?php echo site_url('home/login'); ?>">LOGIN</a></li>
        <li style="float:right"><a href="<?php echo site_url('home/about_us'); ?>">About Us</a></li>
    </ul>
    
    <div class="hero-text">
    <h1>SOUVENIRS LAMPUNG</h1>
    <div class="link">
